...
buildscript {
    ...
    configurations.classpath {
        resolutionStrategy {
            ...
            force("io.netty:netty-transport-native-epoll:4.2.15.Final")
            ...
            dependencySubstitution {
                ...
                substitute(module("io.netty:netty-codec-http2")).using(module("io.netty:netty-codec-http2:4.2.15.Final"))
                substitute(module("io.netty:netty-handler")).using(module("io.netty:netty-handler:4.2.15.Final"))
                substitute(module("io.netty:netty-codec")).using(module("io.netty:netty-codec:4.2.15.Final"))
                substitute(module("io.netty:netty-common")).using(module("io.netty:netty-common:4.2.15.Final"))
                substitute(module("io.netty:netty-codec-http")).using(module("io.netty:netty-codec-http:4.2.15.Final"))
                substitute(module("io.netty:netty-transport-native-epoll")).using(module("io.netty:netty-transport-native-epoll:4.2.15.Final"))
                substitute(module("io.netty:netty-transport-native-unix-common")).using(module("io.netty:netty-transport-native-unix-common:4.2.15.Final"))
