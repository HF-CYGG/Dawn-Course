...
buildscript {
    ...
    configurations.classpath {
        resolutionStrategy {
            ...
            force("io.netty:netty-transport-native-epoll:4.2.14.Final")
            force("io.netty:netty-transport-native-unix-common:4.2.14.Final")
            ...
            force("com.google.protobuf:protobuf-java:4.35.0")
            ...
            dependencySubstitution {
                ...
                substitute(module("com.google.protobuf:protobuf-java")).using(module("com.google.protobuf:protobuf-java:4.35.0"))
                ...
                substitute(module("io.netty:netty-codec-http2")).using(module("io.netty:netty-codec-http2:4.2.14.Final"))
                substitute(module("io.netty:netty-handler")).using(module("io.netty:netty-handler:4.2.14.Final"))
                substitute(module("io.netty:netty-codec")).using(module("io.netty:netty-codec:4.2.14.Final"))
                substitute(module("io.netty:netty-common")).using(module("io.netty:netty-common:4.2.14.Final"))
                substitute(module("io.netty:netty-codec-http")).using(module("io.netty:netty-codec-http:4.2.14.Final"))
                substitute(module("io.netty:netty-transport-native-epoll")).using(module("io.netty:netty-transport-native-epoll:4.2.14.Final"))
                substitute(module("io.netty:netty-transport-native-unix-common")).using(module("io.netty:netty-transport-native-unix-common:4.2.14.Final"))
